...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { category: @notification.category, d_day: @notification.d_day, filename: @notification.filename } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { category: @notification.category, d_day: @notification.d_day, filename: @notification.filename } }
